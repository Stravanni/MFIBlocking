package il.ac.technion.ie.dataset.prepare.oldFiles;
...
public class Lexicon {
    ...
    private Map<Integer, AttributeItems> attIdToItems = new HashMap<>();
    private Map<Integer, Double> attIdToWeights = new HashMap<>();
    private Map<Integer, Integer> columnIndexToId = new HashMap<>();
    ...
    private Map<Integer, Integer> attIdToPrefixLength = new HashMap<>();
